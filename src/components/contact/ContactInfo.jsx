        ...
        {contactItems.map((item) => {
          ...
          return (
            <a
              ...
              className="group flex items-start gap-3 rounded-xl border border-gold/35 bg-cream px-4 py-3 transition-colors hover:bg-white"
            >
              <span className="mt-0.5 inline-flex h-9 w-9 items-center justify-center rounded-full bg-gold text-black">
                <Icon size={17} />
              </span>
              <span>
